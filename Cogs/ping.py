...
class Ping(commands.Cog):
    ...
    async def ping(self,ctx):
        if round(self.Bot.latency * 1000) > 100:
            ...
            REDembed.set_footer(text="Calculator#0261",icon_url=self.Bot.user.avatar_url)
            ...
            ORANGEembed.set_footer(text="Calculator#0261",icon_url=self.Bot.user.avatar_url)
            ...
            GREENembed.set_footer(text="Calculator#0261",icon_url=self.Bot.user.avatar_url)
